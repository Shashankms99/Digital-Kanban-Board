...
function EditIssueModal({ isOpen, onClose, onSubmit, issueData, projects = [], currentProject, users = [] }) {
            ...
            const fetchbacklog = async () => {
                try {
                    ...
                    const response = await fetch(
                        `http://localhost:8080/sprintitems/getsubbacklogdata/${issueData._id}`,
                        {
                            method: 'GET',
                            headers: {
                    ...
                    if (response.ok) {
                        ...
                        toast.error(data.message || "Failed to fetch backlog data");
                    }
                } catch (error) {
                    toast.error("Error fetching backlog data");
